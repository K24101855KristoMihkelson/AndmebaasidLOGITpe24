...
--- näitab nimed üks kord
select distinct Name, DepartmentId from Employees

---näitab kõik rahad kokku
...
--kirjutame lihtsamaks, kasutame e ja d tabelinimedena
...
-- kuvatakse tabeli osakene managerID
...
ON e.managerID=m.Id
--right join, võtab employees nullid ja kuvab manageri 
select managerName, name, Salary 
...
--cross join, korrutab kõiki kirjeid mõlemalt tabelilt
select name , managerName, Salary 
